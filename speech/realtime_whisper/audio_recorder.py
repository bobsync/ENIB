...
This file is from RealtimeSTT library
Maxime : added possibility to change post_speech_silence_duration in realtime
"""
...
class AudioToTextRecorder:
    ...
    def __init__(self,
        ...
        #post_speech_silence_duration is now shared across all process
        self.post_speech_silence_duration = mp.Value('d', post_speech_silence_duration)
    ...
    def set_post_speech_silence_duration(self, value):
        """
        Set the post_speech_silence_duration value
        """
        logging.info("Setting post_speech_silence_duration to: " + str(value))
        self.post_speech_silence_duration.value = value
                ...
                if not self.is_recording:
                    ...
                    if self.stop_recording_on_voice_deactivity:
                        ...
                        if self.speech_end_silence_start and time.time() - \
                                ...
                                self.post_speech_silence_duration.value:
